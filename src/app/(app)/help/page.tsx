...
const dailyScreens = [
  { name: "ダッシュボード", when: "朝いちばん", what: "今Qの商談・契約の進み具合、next actionが空の案件、ジャンルの狙い目を確認する" },
  ...
  { name: "MTG LOG", when: "打ち合わせの後", what: "話した内容と困ったことを残す" },
];
  ...
  return (
    <PageShell>
      ...
      <Banner tone="info" title="山路さんに聞きたい時（ラリーを減らす仕組み）">
        一人で判断できないこと（PB品どうする、メーカー紹介いる？等）が出たら、案件やMTG LOGから「困ったこと」として登録してください。
